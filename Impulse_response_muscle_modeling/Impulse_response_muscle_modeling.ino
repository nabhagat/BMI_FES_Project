...
const int num_stim_samples_reqd = 2000; // @ 4Khz sampling freq, 2000 samples = 500 ms data
const int num_force_samples_reqd = 100; // @ 100Hz sampling freq, 100 samples = 1 sec.
